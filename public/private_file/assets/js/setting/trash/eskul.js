$(document).ready(function() {
    ...
    Table({table:'table', data:data, url:'/api/v1/trash/eskul/get'})
    ...
    $('#recoveryData').on('click', function (e) {
        ...
        SweetQuestions({
            ...
            subtitle : 'Apakah anda ingin merestore data eskul ini?',
            buttonConfirm : 'Yes',
            buttonDeny: 'No',
            confirm : 'ajax',
            deny : {
            ...
            ajax : {
                url:'/api/v1/trash/eskul/recovery',
                data:{
    ...
    $('#deleteData').on('click', function (e) {
        ...
        SweetQuestions({
            title : 'Apakah anda yakin?',
            subtitle : 'Apakah anda ingin menghapus data eskul ini?',
            buttonConfirm : 'Yes',
            buttonDeny: 'No',
            confirm : 'ajax',
            deny : {
